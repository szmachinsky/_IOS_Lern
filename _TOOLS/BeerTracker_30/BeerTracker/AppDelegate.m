...
static NSString * const kRecipesStoreName = @"BeerModel3.sqlite"; //zss
...
//zs1    [MagicalRecord setupCoreDataStackWithStoreNamed:kRecipesStoreName];
    
//  [MagicalRecord setupClassicStackWithSQLiteStoreNamed:kRecipesStoreName];
    [MagicalRecord setupSQLiteStackWithStoreNamed:kRecipesStoreName];
...
//        [[NSManagedObjectContext MR_defaultContext] MR_saveToPersistentStoreWithCompletion:nil];
        [[NSManagedObjectContext MR_mainQueueContext] MR_saveToPersistentStoreWithCompletion:nil];
